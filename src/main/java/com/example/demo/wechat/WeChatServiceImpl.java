...
import com.example.demo.wechat.models.ArticleItem;
        ...
        try {
            ...
            if (msgType.equals(WeChatContant.REQ_MESSAGE_TYPE_TEXT)) {
                ...
                if (mes != null && mes.length() < 2) {
                    ...
                    Map<String, String> userInfo = new HashMap<>(); //getUserInfo(requestMap.get(WeChatContant.FromUserName));
